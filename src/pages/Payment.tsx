...
export default function Payment() {
  ...
  return (
    <div className="container w-[600px]">
      ...
      <div>
        <div className="flex flex-row  mr-[40px] gap-[10px] ml-[434px]">
          <p className="text-[#959595]">배송 비</p>
          <p>{price}원</p>
        </div>
        <div className="flex flex-row  mr-[40px] gap-[12px] ml-[435px]">
      ...
      <div>
        ...
        <div className="w-full flex flex-col mb-[30px]">
          <select
            ...
            // value={"결제 방법을 선택하세요"}
          >
            <option value={"결제 방법을 선택하세요"}>
              결제 방법을 선택하세요
            </option>
            <option value={"카드결제"}>카드이체</option>
            <option value={"계좌이체"}>계좌이체</option>
            <option value={"페이결제"}>페이이체</option>
          </select>
        </div>
        <button
